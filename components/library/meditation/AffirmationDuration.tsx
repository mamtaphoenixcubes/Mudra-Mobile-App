...
interface AffirmationDurationProps {
    mudra?: Mudra;
...
export default function AffirmationDuration({
    mudra,
    selectedDuration,
    onDurationChange,
    onDurationPress,
}: AffirmationDurationProps) {
    const durationConfig = mudra?.durationPickerCard;
        ...
        <View style={styles.container}>
            ...
            >
                ...
                <Text style={styles.affirmationText}>
                    {mudra?.affirmationCard?.cardText}
                </Text>
