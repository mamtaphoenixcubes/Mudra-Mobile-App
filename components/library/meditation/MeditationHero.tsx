...
export default function MeditationHero({
    ...
    const images = Array.isArray(mudra?.image)
        ? mudra.image.map((img: any) => ({
    ...
    const intentions = Array.isArray(mudra?.intentions)
        ? mudra.intentions.map((item: any) => item.name)
        : [];
        ...
        <View style={[styles.container, { backgroundColor: colors.background }]}>
            <View style={styles.row}>
                ...
                <View style={styles.rightCol}>
                    <Text style={[styles.mudraName, { color: colors.text }]}>
                        {mudra?.name}
                    </Text>
