...
export default function MeditationHero({
    ...
    const images = Array.isArray(meditation?.image)
        ? meditation.image.map((img: any) => ({
    ...
    const intentions = Array.isArray(meditation?.intentions)
        ? meditation.intentions.map((item: any) => item.name)
        : [];
