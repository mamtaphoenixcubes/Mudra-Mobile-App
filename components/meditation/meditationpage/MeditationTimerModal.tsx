...
const MeditationTimerModal = ({
    ...
    const saveProgress = async () => {
        if (!meditationId || !profileDocumentId) return;
        try {
            await axios.post(
                `${process.env.EXPO_PUBLIC_API_URL}/meditations/${meditationId}/progress`,
    ...
    const handleComplete = async () => {
        ...
        try {
            const completeRes = await axios.post(
                `${process.env.EXPO_PUBLIC_API_URL}/meditations/${meditationId}/complete`,
...
export default MeditationTimerModal;
