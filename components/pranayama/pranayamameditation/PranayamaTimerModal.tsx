...
interface PranayamaTimerModalProps {
    visible: boolean;
...
const PranayamaTimerModal = ({
    ...
    const saveProgress = async () => {
        if (!pranayamaId || !profileDocumentId) return;
        try {
            await axios.post(
                `${process.env.EXPO_PUBLIC_API_URL}/pranayamas/${pranayamaId}/progress`,
    ...
    const handleComplete = async () => {
        ...
        try {
            const completeRes = await axios.post(
                `${process.env.EXPO_PUBLIC_API_URL}/pranayamas/${pranayamaId}/complete`,
...
export default PranayamaTimerModal;
