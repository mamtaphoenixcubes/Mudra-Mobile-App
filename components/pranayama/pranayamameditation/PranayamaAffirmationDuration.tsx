...
interface PranayamaAffirmationDurationProps {
    pranayama?: Pranayama;
...
export default function PranayamaAffirmationDuration({
    pranayama,
    selectedDuration,
    onDurationChange,
    onDurationPress,
}: PranayamaAffirmationDurationProps) {
    const durationConfig = pranayama?.durationPickerCard;
        ...
        <View style={styles.container}>
            ...
            >
                ...
                <Text style={styles.affirmationText}>
                    {pranayama?.affirmationCard?.cardText}
                </Text>
