...
export default function PranayamaDetailHero() {
    ...
    return (
        <View style={styles.heroContainer}>
            <Text style={styles.pageTitle}>Pranayama Detail</Text>
            ...
            <View style={styles.heroTopRow}>
                ...
                <View style={styles.heroTextBlock}>
                    ...
                    <Text style={styles.heroTitle}>Nadi Shodhana</Text>
                    <Text style={styles.heroSubtitle}>
                        A calming alternate-nostril breathing technique that balances the nervous system and clears the mind.
                    </Text>
                </View>
            </View>
