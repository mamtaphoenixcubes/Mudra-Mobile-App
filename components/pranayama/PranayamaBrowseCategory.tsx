...
const BROWSE_CATEGORIES: PranayamaCategory[] = [
    {
        id: 'calming',
        title: 'Calming',
        description: 'Slow, soothing breath techniques.',
        practiceCount: 3,
    ...
    },
    {
        id: 'energizing',
        title: 'Energizing',
        description: 'Techniques that build heat and energy.',
        practiceCount: 2,
    ...
    },
    {
        id: 'balancing',
        title: 'Balancing',
        description: 'Restore harmony to the nervous system.',
        practiceCount: 1,
        icon: require('@/assets/images/CategoryIcon/Chakra.png'),
    },
];
...
export default function PranayamaBrowseCategory() {
